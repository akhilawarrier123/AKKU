		...
		jButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if ((thr > 24) || (tmin > 60))
					...
					Error.setText("Please enter valid detais");
				...
				// to be in exit layout
				// System.out.println(map);
				String sp = map.get(t1.getText()); // testing using the input vehicle number from entry
				String[] s = sp.split(",");
				...
				Integer Rate = M.get(cb.getSelectedItem());
				System.out.println(Rate);
				Integer m = Integer.parseInt(s[0]);
				Integer I = (((1440 - m) / 60) * Rate);
